window.LArea = function() {
    ...
    return e.prototype = {
        init: function(e) {
            switch (this.params = e, this.trigger = document.querySelector(e.trigger), e.valueTo && (this.valueTo = document.querySelector(e.valueTo)), e.valueIndex && (this.valueIndex = document.querySelector(e.valueIndex)), this.keys = e.keys, this.type = e.type || 1, this.type) {
            case 1:
            case 2:
                break;
            default:
        ...
        finish: function(e) {
            ...
            t.value = [n, o, l],
            this.valueIndex && (this.valueIndex.value = n + ',' + o + ',' + l),
